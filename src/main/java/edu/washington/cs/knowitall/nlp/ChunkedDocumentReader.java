...
public class ChunkedDocumentReader {
    ...
    /**
     * @param sentExtractor the object responsible for converting a String to 
     * String sentences
     * @param sentChunker the object responsible for converting a String 
     * sentence to a {@link ChunkedSentence} object
     * @throws IOException
     */
    ...
    /**
     * Uses the object returned by 
     * {@link DefaultObjects#getDefaultHtmlSentenceExtractor()}
     * as the default sentence extractor, and {@link OpenNlpSentenceChunker} as 
     * the default sentence chunker.
     * @throws IOException
     */
    ...
    /**
     * Reads a document from the given file, using {@link File#getAbsolutePath()}
     * as the id of the document.
     * @param file
     * @return the document
     * @throws ExtractorException
     */
     ...
     * @param id
     * @return the document
     * @throws ExtractorException if unable to run sentence extractor
     */
    public ChunkedDocument readDocument(String docStr, String id) 
        throws ExtractorException {
        ArrayList<String> sents = new ArrayList<String>();
        Iterables.addAll(sents, sentExtractor.extract(docStr));
        ArrayList<ChunkedSentence> chunkedSents = 
            new ArrayList<ChunkedSentence>(sents.size());
        ...
        for (String sent : sents) {
            try {
                ...
                String msg = String.format(
                    "Could not chunk sentence %s in document %s", sentNum, id);
