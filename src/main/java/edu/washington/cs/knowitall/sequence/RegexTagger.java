 ...
 * </p>
 * <p>
 * For example, given the sequence "she sells sea shells by the shore", the
 * tag symbol "X" and a regular expression that matches the words starting with 
 * s, the tagger will return the list [X, X, X, X, O, O, X].
 * </p>
 * @author afader
 *
 */
public class RegexTagger {
	 ...
	 * @param tag the tag to use for matching tokens
	 */
