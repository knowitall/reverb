...
/***
 * Represents a layered sequence of strings. An example of a layered
 * sequence is a POS-tagged sentence, which has a word layer, and a 
 * POS tag layer. 
 * 
 * This interface defines the basic functionality expected from a layered
 * sequence, namely the ability to access the value of the sequence at a
 * given index of the given layer.
 * 
 * @author afader
 *
 */
public interface LayeredSequence {
	 ...
	 * @throws IllegalArgumentException if a layer with name layerName does not
	 * exist
	 */
