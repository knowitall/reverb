...
public class PatternExtractor{
	...
	private void initPatternMap(){
		...
		patternMapArg1.put("between_quotes", "<>* <string='``'> <>* <string=''''> <>*");
		...
		patternMapArg1.put("verb_conj_simple1", np+" "+advp+"* "+vp2+" "+"("+pp+"? "+np+")* "+comma+"* "+"("+comma+" | <pos='CC'>) <pos='RB'>? "+advp+"*");
		patternMapArg1.put("statement","<>* "+comma+" "+np+" "+vp+" "+advp+"* <string='.'>");

		patternMapArg1.put("list_3", "("+np_pp+" "+comma+")* "+np_pp+" "+comma+"? ("+and+" | "+or+") "+np_pp);
    	patternMapArg1.put("list_1", "("+np+" "+comma+")* "+np+" "+comma+"? ("+and+" | "+or+") "+np);
    	patternMapArg1.put("list_2", "("+np+" "+comma+")* "+np+" "+comma+"? ("+and+" | "+or+") <chunk='I-NP'> (<chunk='I-NP'>)*");
    	patternMapArg1.put("obj", "<>* "+vp+" "+pp+"? "+np_pp);
		patternMapArg1.put("contains_interv_clause1", np+" "+comma+" "+pp+"+ "+np+" ("+pp+"? "+np+")* "+comma+" "+advp+"? "+vp+"? ");
    	patternMapArg1.put("contains_interv_clause2", np+" "+comma+" "+np+" "+vp+" "+comma+" "+advp+"? "+vp+"? ");
		patternMapArg1.put("to_verb", " <>* <pos='TO'> <chunk='I-VP'>* <chunk='B-PRT'>? <>* ");
		patternMapArg1.put("subj_simple", np+" "+advp+"*");
		patternMapArg1.put("subj_rel", np+" "+comma+"* (<pos='WP'> | <pos='WDT'> | <string='that'>) "+advp+"*");
		patternMapArg1.put("subj_quotes1", "<> "+comma+"* (<string=''''> | <string='``'>) "+advp+"*");
		patternMapArg1.put("subj_quotes2", np+" "+comma+"* (<string=''''> | <string='``'>) "+advp+"*");
		patternMapArg1.put("subj_4", "("+np+" "+vp+" "+"("+pp+"* "+np+" ("+pp+" "+np+")*)* "+comma+")* "+vp+" ("+pp+"* "+np+" ("+pp+" "+np+")*)* "+ comma+"* ("+comma+" | "+and+"| "+or+") "+advp+"*");
		patternMapArg1.put("subj_5a", comma+" "+pp+"* "+np+" ("+pp+"* "+np+")* "+adjp+"* "+comma+" "+advp+"*");
		patternMapArg1.put("subj_5b", comma+" <pos='VBN'> ("+pp+"* "+np+")* "+adjp+"* "+comma+" "+advp+"*");
		patternMapArg1.put("subj_5c", comma+" "+np+"* <pos='CC'> ("+pp+"* "+np+")* "+adjp+"* "+comma+" "+advp+"*");
    	patternMapArg1.put("subj_6",  np+"* "+comma+" "+advp+"*");
		patternMapArg1.put("relative_clause", "<>* "+np+" "+comma+"? (<pos='WDT'> | <pos='WP'> | <string='that'>) "+vp+" "+pp+"? "+np_pp);//+vp+" "+pp_np2+"? "+comma+"? ");
		
		patternMapArg2.put("np_list", np+" ("+comma+" "+np+")* "+comma+" "+np+" <>*");
		patternMapArg2.put("np_list_cc", np+" <pos='CC'> "+np+" <>* ");
    	patternMapArg2.put("relative_clause", (vp1+" "+pp+"? "+np_pp+" "+comma+"? "+pp+"? (<pos='WP'> | <pos='WDT'> | <pos='WRB'> | <string='that'>) <>* "));
    	patternMapArg2.put("contains_relative_clause", "<>* <chunk='B-NP'> <>* (<string='that'> | <chunk='B-SBAR'> | <pos='WDT'> | <pos='WP'> | <pos='WRB'>) <>* ");
    	patternMapArg2.put("contains_relative_clause2","<>* <chunk='B-NP'> <>* (<chunk='B-SBAR'> | <pos='WDT'> | <pos='WRB'>) <>* ");

    	patternMapArg2.put("nested_relation1", (advp_vp_advp+" (("+comma+" | <string=':'>)? (<string='``'> | <string='\"'>))? "+pp+"? "+np+" ("+pp+" "+np+")? "+advp+"? "+vp2+" <>*"));
    	patternMapArg2.put("nested_relation2", (advp_vp_advp+" "+np+" <chunk='B-SBAR'> <>*"));
    	patternMapArg2.put("nested_relation3", (advp_vp_advp+" "+pp+"? (("+comma+" | <string=':'>)? (<string='``'> | <string='\"'>))? "+np_pp+" "+advp+"? "+vp2+" <>*"));
       	patternMapArg2.put("nested_relation4", "<>* (<chunk='B-SBAR'> | <pos='WRB'> | <pos='WDT'> | <pos='WP'> | <string='that'>) <>* "+vp1+" <>*");
    	patternMapArg2.put("double_np1", np+" "+np+" <>*");
    	patternMapArg2.put("double_np2", np+" "+np+" <chunk='B-VP'> <>*");
    	
    	patternMapArg2.put("infinitive_clause", advp+"? "+vp+"? <chunk='I-VP'>* <pos='TO'> <chunk='I-VP'>+ <>*");
    	patternMapArg2.put("np_infinitive_clause", advp+"? "+vp1+" "+advp+"? "+pp+"? (("+comma+" | <string=':'>)? (<string='``'> | <string='\"'>))? "+np+" "+advp+"? "+vp3+" <>*");

    	patternMapArg2.put("complement_clause1", advp+"? "+vp1+" (<chunk='B-SBAR'> |<pos='WRB'> | <pos='WP'>) <>*");
		patternMapArg2.put("complement_clause2", advp+"? "+vp1+" "+advp+"? <string='that'> "+np+" <>*");
		patternMapArg2.put("objNestedClause", advp+"? "+vp1+" "+advp+"? "+np+" <string='that'> "+np+" "+vp+" <>*");
		patternMapArg2.put("adj_relation", advp+"? (<pos='VBD'> | <pos='VB'> | <pos='VBZ'> | <pos='VBN'> | <pos='VBP'> | <pos='MD'>) <chunk='I-VP'>* "+advp+"? "+" <chunk='B-NP'> <chunk='I-NP'>* <chunk='B-PP'>? <chunk='B-ADJP'> <>*");
		patternMapArg2.put("list1", "<chunk='B-NP'> <chunk='I-NP'>* (<string=','> (<chunk='B-PP'>)? <chunk='B-NP'> <chunk='I-NP'>*)* (<string=','> | (<string=','> <pos='CC'>)) <chunk='B-NP'> <>*");
		patternMapArg2.put("list3", "<chunk='B-NP'> <chunk='I-NP'>* (<string=','> <chunk='B-NP'> <chunk='I-NP'>*)* <string=','>* <pos='CC'> <chunk='B-NP'> <>*");
		patternMapArg2.put("compound1", "<chunk='B-NP'> <chunk='I-NP'>* ((<string=','> <chunk='B-NP'> <chunk='I-NP'>* (<chunk='B-PP'>)?)* (<string=','> | (<string=','> <pos='CC'>)) <chunk='B-NP'> <chunk='I-NP'>)* <string=','>* <pos='CC'> "+advp+"? <chunk='B-VP'> <>*");
		patternMapArg2.put("compound2", "<chunk='B-NP'> <chunk='I-NP'>* (<chunk='B-PP'> <chunk='B-NP'> <chunk='I-NP'>)* <string=','>* <pos='CC'> "+advp+"? <chunk='B-VP'> <>*");
		patternMapArg2.put("ifclause1","<chunk='B-NP'> <chunk='I-NP'>* ((<string=','> <chunk='B-NP'> <chunk='I-NP'>* (<chunk='B-PP'>)?)* (<string=','> | (<string=','> <pos='CC'>)) <chunk='B-NP'> <chunk='I-NP'>)* <string=','>* "+introduces_if+" <>*");
		patternMapArg2.put("ifclause2","<chunk='B-NP'> <chunk='I-NP'>* (<chunk='B-PP'> <chunk='B-NP'> <chunk='I-NP'>)* "+introduces_if+" <>*");
		patternMapArg2.put("relclause1", "<chunk='I-NP'>* <string=','>? (<string='``'> | <string=''''>)? <string=','>? (<pos='WDT'> | <pos='WP'> | <string='that'>) <>* ");
		patternMapArg2.put("relclause2", "<chunk='I-NP'>* <string=','> <string=''''> (<pos='WDT'> | <pos='WP'> | <string='that'>) <>* ");
		patternMapArg2.put("relclause3", "<chunk='I-NP'>* <string=','> (<pos='WDT'> | <pos='WP'> | <string='that'>) <>* ");
		patternMapArg2.put("vbg_1", "<chunk='I-NP'>* <string=','> <pos='VBG'> <>* ");
		patternMapArg2.put("vbg_2", "<chunk='I-NP'>* <pos='VBG'> <>* ");
		patternMapArg2.put("app_1", "<chunk='I-NP'>* (<string='``'> | <string=''''>)? <string=','> <chunk='B-NP'> <chunk='I-NP'>* (<chunk='B-PP'>? <chunk='B-NP'> <chunk='I-NP'>*)* (<string=','> | <string='.'>) <>* ");
		patternMapArg2.put("app_2", "<chunk='I-NP'>* <string=','> (<string='``'> | <string=''''>)? <chunk='B-NP'> <chunk='I-NP'>* (<chunk='B-PP'>? <chunk='B-NP'> <chunk='I-NP'>*)* (<string=','> | <string='.'>) <>* ");
	...
	private void initCompiledPatternMap(){
		...
		while(iter.hasNext()){
			...
			compiledPatternMapArg1.put(key, ChunkedSentencePattern.compile(pattern));
		}
		...
		while(iter.hasNext()){
			...
			compiledPatternMapArg2.put(key, ChunkedSentencePattern.compile(pattern));
		}
	}
	    
    public boolean prevStop(ChunkedExtraction extr, int current){

    	if(!matches(extr.getSentence().getSubSequence(0, extr.getStart()), "between_commas", true) && !matches(extr.getSentence().getSubSequence(0, extr.getStart()), "between_quotes", true)){
			if((!extr.getSentence().getPosTag(current).equals("WDT") && !extr.getSentence().getPosTag(current).equals("WRB") && !extr.getSentence().getPosTag(current).equals("WP") 
					&& matches(extr.getSentence().getSubSequence(0, current+1), "double_np", true)) ||
					matches(extr.getSentence().getSubSequence(0, current+1), "if", true) ||
					matches(extr.getSentence().getSubSequence(0, current+1), "verb_np", true)){
				return true;
			}
    	}
		return false;
	...
	public int getInterveningNPCount(ChunkedExtraction extr, int k) {
		...
		for(int i = k+1; i < extr.getStart(); i++){
			if(extr.getSentence().getChunkTag(i).equals("B-NP") && 
					!(extr.getSentence().getToken(i).equals("which") || extr.getSentence().getToken(i).equals("who") || extr.getSentence().getToken(i).equals("that"))){
				count++;
			}
		}
		return count;
    ...
    public boolean wordAfterIsVP(ChunkedExtraction extr, int current){
		int i = current;
		while(i < extr.getStart() && (extr.getSentence().getChunkTag(i).contains("NP") || extr.getSentence().getChunkTag(i).contains("PP"))){
			i++;
		}
    ...
    public boolean wordBeforeIsVP(ChunkedExtraction extr, int current){
		...
		int i = current;
		while(i >-1 && (extr.getSentence().getChunkTag(i).contains("NP") || extr.getSentence().getChunkTag(i).contains("PP")
				|| extr.getSentence().getChunkTag(i).contains("RB"))){
			i--;
		}
		if(i >-1){
    ...
    public boolean nextIsThat(ChunkedExtraction extr, int current){
    	...
    	while(current < extr.getStart() && 
    			(extr.getSentence().getChunkTag(current).equals("I-NP") 
    					|| extr.getSentence().getToken(current).equals(","))){
    		current++;
    	}
    	if(current >= extr.getStart()){
    		return false;
    	}
    	if(extr.getSentence().getPosTag(current).equals("WP") || extr.getSentence().getPosTag(current).equals("WDT")  || extr.getSentence().getToken(current).equals("that")){
    		return true;
    	}
		return false;
    }
	...
	public boolean matchesPPBeforeVerb(ChunkedExtraction extr) {
		...
		while(i > 0 && extr.getSentence().getChunkTag(i).contains("VP")){
			i--;
			if(extr.getSentence().getPosTag(i).equals("IN") || extr.getSentence().getPosTag(i).equals("TO")){
				return true;
			}
		}
		return false;
    ...
    public boolean matchesAppositiveClause2(ChunkedExtraction extr, int current){
		...
		if(matches(extr.getSentence().getSubSequence(current, length), "app_3", true)){ 
			return true;
		}
		return false;
    }
    ...
    public boolean matchesRelativeClause(ChunkedExtraction extr, int argend){
    	if(matches(extr.getSentence().getSubSequence(0, argend), "relative_clause", true) && 
    			!(extr.getSentence().getChunkTag(argend-1).contains("NP") && extr.getSentence().getChunkTag(argend).equals("B-VP"))){
    		return true;
    	}
    	return false;
    }
    ...
    public boolean matchesQuotes(ChunkedExtraction extr){
    	...
    	if(extr.getSentence().getToken(extr.getStart()-1).equals("''") && extr.getSentence().getToken(extr.getStart()-2).equals(",")){
    		return true;
    	}
    	return false;
    }
    ...
    public boolean matchesStatement(ChunkedExtraction extr){
		...
		if(matches(extr.getSentence().getSubSequence(0, length), "statement", true)){
			return true;
		}
		return false;
    }
    public boolean matchesList(ChunkedExtraction extr, int argend, int current){
    	while(current>-1 && (extr.getSentence().getChunkTag(current).contains("NP") ||
    						...
    						extr.getSentence().getPosTag(current).contains(",") ||
    						extr.getSentence().getPosTag(current).contains("CC"))){
    		int length = argend-current;
    		if ((matches(extr.getSentence().getSubSequence(current, length), "list_1", true) || 
    				matches(extr.getSentence().getSubSequence(current, length), "list_3", true) ||
    				matches(extr.getSentence().getSubSequence(current, length), "list_2", true)) && 
    				(current == 0 || extr.getSentence().getChunkTag(current).equals(",") || !extr.getSentence().getChunkTag(current-1).contains("B-VP") || !extr.getSentence().getChunkTag(current-1).contains("I-VP")) &&
    				(current <= 1 || (!extr.getSentence().getChunkTag(current-1).contains("PP") && 
    						!extr.getSentence().getChunkTag(current-2).contains("V") && !matchesObj(extr,current)))){
    			return true;
    		}
    		current--;
    	}
    ...
    public boolean vpStartsWithTo(ChunkedExtraction extr, int current ){
		int length = extr.getStart()-current;
		return (matches(extr.getSentence().getSubSequence(current, length), "to_verb", true));
    }
  
    public boolean matchesVerbConjSimple(ChunkedExtraction extr, int current){
		if((matches(extr.getSentence().getSubSequence(current, extr.getStart()-current), "verb_conj_simple1", true))){
			return true;
		}
		return false;
    }
    ...
    public boolean matchesAppositiveClause(ChunkedExtraction extr, int current){
    	...
    	while(i>0 && (notseencomma || !extr.getSentence().getChunkTag(i).equals("B-NP"))){
    		if(extr.getSentence().getToken(i).equals(",")){
    			notseencomma = false;
    		}
    		i--;
		...
		if(matches(extr.getSentence().getSubSequence(i, length), "app_1", true) || matches(extr.getSentence().getSubSequence(i, length), "app_2", true)){
			return true;
		}
		return false;
    }
    ...
    public boolean simpleSubj(ChunkedExtraction extr, int i){
    	if(!extr.getSentence().getPosTag(i).startsWith("W") && (matches(extr.getSentence().getSubSequence(i, extr.getStart()-i), "subj_simple", true))){
    		return true;
    	}
    	return false;
    }
    ...
    public boolean quotesSubj(ChunkedExtraction extr, int i){
    	if(matches(extr.getSentence().getSubSequence(i, extr.getStart()-i), "subj_quotes1", true) ||
    			matches(extr.getSentence().getSubSequence(i, extr.getStart()-i), "subj_quotes2", true)){
    		return true;
    	}
    	return false;
    }
    ...
    public boolean relSubj(ChunkedExtraction extr, int i){
    	if(matches(extr.getSentence().getSubSequence(i, extr.getStart()-i), "subj_rel", true)){
    		return true;
    	}
    	return false;
    }
    public boolean findSubj(ChunkedExtraction extr, int i){
    	...
    	while(i > -1){
    		int start = i;
    		int length = extr.getStart()-i;
    		if( (matches(extr.getSentence().getSubSequence(start, length), "subj_4", true)) || 
    						(extr.getSentence().getPosTag(extr.getStart()).equals("VBN") && (matches(extr.getSentence().getSubSequence(start, length), "subj_6", true))||
    						(npcount < 1 && (matches(extr.getSentence().getSubSequence(start, length), "subj_5a", true))||
    								(matches(extr.getSentence().getSubSequence(start, length), "subj_5b", true))||
    								(matches(extr.getSentence().getSubSequence(start, length), "subj_5c", true))))){
    			return true;
    		}
    		i--;
    	}
    ...
    public boolean appClause(ChunkedExtraction extr, int current){
    	ChunkedSentence tocheck = extr.getSentence().getSubSequence(current, extr.getSentence().getLength()-current);
    	//matches pattern
    	if(matches(tocheck, "app_1", false) || matches(tocheck, "app_2", false)){
    		return true;
    	}
    	return false;
    }
    public boolean vbgIsNext(ChunkedExtraction extr, int current){
    	ChunkedSentence tocheck = extr.getSentence().getSubSequence(current, extr.getSentence().getLength()-current);
    	//matches pattern
    	if(matches(tocheck, "vbg_1", false) || matches(tocheck, "vbg_2", false)){
    		return true;
    	}
    	return false;
    }
    ...
    public boolean relClause(ChunkedExtraction extr, int current){
    	ChunkedSentence tocheck = extr.getSentence().getSubSequence(current, extr.getSentence().getLength()-current);
    	//matches pattern
    	if(matches(tocheck, "relclause1", false) || matches(tocheck, "relclause2", false) || matches(tocheck, "relclause3", false)){
    		return true;
    	}
    	return false;
    }
    ...
    public boolean ifClause(ChunkedExtraction extr){
    	...
    	//matches pattern
    	if(matches(tocheck, "ifclause1", false) || matches(tocheck, "ifclause2", false) ){
    		return true;
    	}
    	return false;
    }
    public boolean compoundVerb(ChunkedExtraction extr){
    	ChunkedSentence tocheck = getChunkedSentenceFromPredEnd(extr);
    	//matches pattern
    	if(matches(tocheck, "compound1", false) || matches(tocheck, "compound2", false) ){
    		return true;
    	}
    	return false;
    }
    ...
    public boolean startsList(ChunkedExtraction extr){
    	...
    	ChunkedSentence tocheck = getChunkedSentenceFromPredEnd(extr);
    	//matches pattern
    	if(matches(tocheck, "list1", false) || matches(tocheck, "list3", false) ){
    		return true;
    	}
    	return false;
    }
    ...
    public boolean complementClause(ChunkedExtraction extr){
    	...
    	ChunkedSentence tocheck = getChunkedSentenceFromPred(extr);
    	//matches pattern
    	if(matches(tocheck, "complement_clause1", false) || matches(tocheck, "complement_clause2", false)){
    		return true;
    	}
    	return false;
    ...
    public boolean doubleNP(ChunkedExtraction extr){
    	...
    	ChunkedSentence tocheck = getChunkedSentenceFromPredEnd(extr);
    	//matches pattern
    	if(matches(tocheck, "double_np1", false) && !matches(tocheck, "double_np2", false)){
    		return true;
    	}
    	return false;
    }
    public boolean nestedRelation1(ChunkedExtraction extr){
		...
		if(matches(tocheck, "nested_relation1", false) ){
    		...
    		for(int i = extr.getStart(); i< extr.getStart()+extr.getLength(); i++){
    			if(extr.getSentence().getPosTag(i).startsWith("V") || extr.getSentence().getChunkTag(i).equals("B-NP")){
    				count++;
    			}
    		}
    		if(count < 2){
    ...
    public boolean nestedRelation2(ChunkedExtraction extr){
		...
		if(matches(tocheck, "nested_relation1", false) && !complementClause(extr)){
			int count = 0;
    		for(int i = extr.getStart(); i< extr.getStart()+extr.getLength(); i++){
    			if(extr.getSentence().getPosTag(i).startsWith("V") || extr.getSentence().getChunkTag(i).equals("B-NP")){
    				count++;
    ...
    public boolean matchesNPList(ChunkedExtraction extr){
		...
		ChunkedSentence tocheck = extr.getSentence().getSubSequence(start, length);
    ...
    public static ChunkedSentence getChunkedSentenceFromPred(ChunkedExtraction extr){
		int pred_start_orig = extr.getStart();
		int start = pred_start_orig;
		for(int i = pred_start_orig; i < pred_start_orig+extr.getLength(); i++){
			if(extr.getSentence().getChunkTag(i).contains("I-VP") || extr.getSentence().getChunkTag(i).contains("B-VP")){
				start = i;
			}
		}
    ...
    public static ChunkedSentence getChunkedSentenceFromPredEnd(ChunkedExtraction extr){
	...
	public boolean matches(ChunkedSentence sentence, String type, boolean arg1){
		...
		if(arg1){
			match = compiledPatternMapArg1.get(type).match(ChunkedSentenceToken.tokenize(sentence));
		}
		else{
			match = compiledPatternMapArg2.get(type).match(ChunkedSentenceToken.tokenize(sentence));
		}
    ...
    public static boolean inNPList(ChunkedExtraction extr, int current){
    	...
    	for(int i = start; i < current+1; i++){
    		if((extr.getSentence().getToken(i).equals("which") || extr.getSentence().getToken(i).equals("that") || extr.getSentence().getToken(i).equals("who"))||
    				(!extr.getSentence().getChunkTag(i).equals("B-NP") && !extr.getSentence().getChunkTag(i).equals("I-NP")
    				 && !extr.getSentence().getToken(i).equals("and") && !extr.getSentence().getToken(i).equals("or") 
    				 && !extr.getSentence().getToken(i).equals(","))){
    			return false;
    		}
    		if( extr.getSentence().getToken(i).equals("and") || extr.getSentence().getToken(i).equals("or") || extr.getSentence().getToken(i).equals(",")){
    			comma_cc_count++;
    		}
    	}
    	if(comma_cc_count>0){
    ...
    public static boolean inPPList(ChunkedExtraction extr, int current){
    	...
    	for(int i = start; i < current+1; i++){
    		if((extr.getSentence().getToken(i).equals("which") || extr.getSentence().getToken(i).equals("that") || extr.getSentence().getToken(i).equals("who"))||
    				(!extr.getSentence().getChunkTag(i).equals("B-NP") && !extr.getSentence().getChunkTag(i).equals("I-NP")
    				 && !extr.getSentence().getChunkTag(i).equals("B-PP") && !extr.getSentence().getChunkTag(i).equals("I-PP"))){
    			return false;
    		}
    ...
    public static boolean previousIsOf(ChunkedExtraction extr, int current){
    	...
    	while(current > extr.getStart()+extr.getLength()){
    		if(extr.getSentence().getChunkTag(current).contains("NP") || extr.getSentence().getChunkTag(current).contains("VP")){
    			break;
    		}
    ...
    public static boolean nextIsVP(ChunkedExtraction extr, int current){    	
    	...
    	if(next > -1 && next < extr.getSentence().getLength()){
    		if(extr.getSentence().getPosTag(next).contains("V") || extr.getSentence().getChunkTag(next).contains("V")){
    			return true;
    		}
    	}
    	return false;
