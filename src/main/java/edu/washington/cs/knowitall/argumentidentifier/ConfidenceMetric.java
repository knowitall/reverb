...
public class ConfidenceMetric implements ConfidenceFunction {
    ...
    public double getConf(ChunkedBinaryExtraction extr)
        ...
        StringReader testreader = new StringReader(header + features
                + ",true\n");
        ...
        try {
            ...
            return classifier.distributionForInstance(testinginstances
                    .firstInstance())[0];
    ...
    public String getAllMetrics(ChunkedBinaryExtraction extr) {
        ...
        boolean npinf = pattern_extractor
                .npInfinitiveClause(extr.getRelation());
