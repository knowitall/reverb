 ...
 * 		1
 * 
 * This gets loaded into a <code>LabeledBinaryExtraction</code> object representing 
...
public class LabeledBinaryExtractionReader {
	 ...
	 * @param in
	 * @throws IOException if unable to read the source
	 */
	...
	/**
	 * @return an <code>Iterable</code> object containing the labeled extractions
	 * @throws IOException
	 */
