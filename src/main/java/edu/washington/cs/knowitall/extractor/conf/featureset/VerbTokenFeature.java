...
/**
 * Parent class for any feature that considers only 
 * tokens whose corresponding pos starts with "V" or equals "MD".
 * @author Rob
 *
 */
public abstract class VerbTokenFeature extends ExtractionFeature {
	...
	protected boolean testAtIndex(Integer index, ChunkedSentence sentence) {
		...
		if (!pos.startsWith("V") && !pos.startsWith("MD")) return false; 
