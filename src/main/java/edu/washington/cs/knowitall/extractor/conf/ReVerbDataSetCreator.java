 ...
 * file. See the documentation for <code>LabeledBinaryExtractionReader</code> for
...
public class ReVerbDataSetCreator {
	...
	/**
	 * Runs ReVerb on the given file (the first argument), and writes the output to the
	 * given target file (the second argument). If the first argument is "-", then reads the
