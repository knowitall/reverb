...
public class WekaFeatureSet<T> {
    ...
    public FastVector getAttributesCopy() {
        ...
        for (int i = 0; i < numFeatures + 1; i++) {
            attributesCopy.addElement(attributes.elementAt(i));
        }
        return attributesCopy;
    }

    /**
     * Returns the feature representation of the given object as a Weka
     * <code>Instance</code> object. Does not add a class value attribute to the
     * instance object.
     *
     * @param object
     * @return
    ...
    /**
     * Returns the feature representation of the given object as a Weka
     * <code>Instance</code> object. Sets the class attribute to the given
     * label.
     *
     * @param object
     * @param label
