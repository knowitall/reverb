...
public abstract class PosFeature extends ExtractionFeature {
	...
	/**
	 * Given a ChunkedBinaryExtraction, I need the implementation to tell
	 * me at which indices to test my predicate. 
	 * @return
	 */
	@Override
	...
	/**
	 * Get a feature that fires if any pos tag from posTags is present
	 * within a given single verb relation (false if multiple-token rel)
	 * @param posTags
	 * @return
	 */
